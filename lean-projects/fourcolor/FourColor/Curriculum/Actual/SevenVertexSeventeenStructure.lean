...
/-- In the seven-vertex `|E| = 17` branch, every degree is one of `4`, `5`, or `6`.

Source: new theorem from the local lower bound `degree ≥ 4` together with the trivial upper bound
`degree ≤ 6` on seven vertices. -/
theorem IsIncidenceCriticalNonColorable.degree_eq_four_or_five_or_six_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    (h : IsIncidenceCriticalNonColorable G 4)
    (hcard : Fintype.card V = 7) (_hedge : G.edgeFinset.card = 17) (v : V) :
...
/-- Exact degree-count split in the seven-vertex `|E| = 17` branch.

Source: new theorem from handshaking with all degrees constrained to lie in `{4,5,6}`. The four
integer solutions are the exact profiles that remain to be analyzed in the live seven-vertex
frontier. -/
theorem IsIncidenceCriticalNonColorable.degree_count_case_split_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    (h : IsIncidenceCriticalNonColorable G 4)
        ...
        Finset.sum Finset.univ (fun v : V =>
          (if G.degree v = 4 then 4 else 0) +
            (if G.degree v = 5 then 5 else 0) +
              (if G.degree v = 6 then 6 else 0)) = 34 := by
      calc
        Finset.sum Finset.univ (fun v : V =>
          (if G.degree v = 4 then 4 else 0) +
            (if G.degree v = 5 then 5 else 0) +
...
/-- In the seven-vertex `|E| = 17` branch, some vertex has degree `4`.

Source: new corollary of the exact degree-count split. -/
theorem IsIncidenceCriticalNonColorable.exists_degree_eq_four_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    (h : IsIncidenceCriticalNonColorable G 4)
    (hcard : Fintype.card V = 7) (hedge : G.edgeFinset.card = 17) :
    ∃ v : V, G.degree v = 4 := by
  classical
...
/-- Vertex-critical lift of the seven-vertex `17`-edge degree-count split. -/
theorem IsVertexCriticalNonColorable.degree_count_case_split_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    ...
    (d4 = 1 ∧ d5 = 6 ∧ d6 = 0) ∨
      ...
      (d4 = 3 ∧ d5 = 2 ∧ d6 = 2) ∨
      (d4 = 4 ∧ d5 = 0 ∧ d6 = 3) :=
  h.toIncidenceCritical_four.degree_count_case_split_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    hcard hedge

/-- Vertex-critical lift of the seven-vertex `17`-edge degree-`4` existence theorem. -/
theorem IsVertexCriticalNonColorable.exists_degree_eq_four_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    (h : IsVertexCriticalNonColorable G 4)
    (hcard : Fintype.card V = 7) (hedge : G.edgeFinset.card = 17) :
    ∃ v : V, G.degree v = 4 :=
  h.toIncidenceCritical_four.exists_degree_eq_four_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    hcard hedge
...
/-- Minimal-counterexample lift of the seven-vertex `17`-edge degree-count split. -/
theorem IsMinimalNonColorable.degree_count_case_split_of_card_eq_seven_of_card_edgeFinset_eq_seventeen_and_forall_exists_adj
    ...
    (d4 = 1 ∧ d5 = 6 ∧ d6 = 0) ∨
      ...
      (d4 = 3 ∧ d5 = 2 ∧ d6 = 2) ∨
      (d4 = 4 ∧ d5 = 0 ∧ d6 = 3) :=
  (h.toIncidenceCritical hadj).degree_count_case_split_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    hcard hedge

/-- Minimal-counterexample lift of the seven-vertex `17`-edge degree-`4` existence theorem. -/
theorem IsMinimalNonColorable.exists_degree_eq_four_of_card_eq_seven_of_card_edgeFinset_eq_seventeen_and_forall_exists_adj
    (h : IsMinimalNonColorable G 4) (hadj : ∀ v : V, ∃ w, G.Adj v w)
    (hcard : Fintype.card V = 7) (hedge : G.edgeFinset.card = 17) :
    ∃ v : V, G.degree v = 4 :=
  (h.toIncidenceCritical hadj).exists_degree_eq_four_of_card_eq_seven_of_card_edgeFinset_eq_seventeen
    hcard hedge

/-- Minimal-counterexample lift of the seven-vertex `17`-edge degree-count split under
`K₅`-freeness without a separate no-isolated-vertices hypothesis. -/
theorem IsMinimalNonColorable.degree_count_case_split_of_card_eq_seven_of_card_edgeFinset_eq_seventeen_of_cliqueFree
  ...
  exact hinc.degree_count_case_split_of_card_eq_seven_of_card_edgeFinset_eq_seventeen hcard hedge

/-- Minimal-counterexample lift of the seven-vertex `17`-edge degree-`4` existence theorem under
`K₅`-freeness without a separate no-isolated-vertices hypothesis. -/
theorem IsMinimalNonColorable.exists_degree_eq_four_of_card_eq_seven_of_card_edgeFinset_eq_seventeen_of_cliqueFree
    (h : IsMinimalNonColorable G 4)
    (hcard : Fintype.card V = 7) (hfree : G.CliqueFree 5) (hedge : G.edgeFinset.card = 17) :
    ∃ v : V, G.degree v = 4 := by
  let hinc : IsIncidenceCriticalNonColorable G 4 :=
    h.toIncidenceCritical (h.forall_exists_adj_of_card_eq_seven_of_cliqueFree hcard hfree)
  exact hinc.exists_degree_eq_four_of_card_eq_seven_of_card_edgeFinset_eq_seventeen hcard hedge
