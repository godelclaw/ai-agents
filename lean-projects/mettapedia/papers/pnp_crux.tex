...
determines the repeated success event on a positive-mass prefix.
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  prefix points.  This fixed-field premise is strictly stronger than global half-success:
  ...
  position after the preceding success-event history has been accumulated.
