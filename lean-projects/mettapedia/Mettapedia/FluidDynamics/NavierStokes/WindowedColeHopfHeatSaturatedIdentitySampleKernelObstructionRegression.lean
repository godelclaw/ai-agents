import Mettapedia.FluidDynamics.NavierStokes.WindowedColeHopfHeatSaturatedIdentitySampleKernelObstruction

/-!
# Regression Tests for Componentwise Saturated Identity-Sample Obstruction
-/
...
namespace WindowedColeHopfHeatSaturatedIdentitySampleKernelObstructionRegression
...
theorem not_exists_windowedColeHopfHeatIdentitySampleKernelTopDownBridge_eq_saturatedCandidate_of_abs_ne_abs_of_componentwise_constant_regression
  ...
  simpa [liveOnlyIdentitySampleKernel] using
    L.not_exists_windowedColeHopfHeatIdentitySampleKernelTopDownBridge_eq_saturatedCandidate_of_abs_ne_abs_of_componentwise_abs_le
...
end WindowedColeHopfHeatSaturatedIdentitySampleKernelObstructionRegression
end NavierStokes
end FluidDynamics
end Mettapedia
